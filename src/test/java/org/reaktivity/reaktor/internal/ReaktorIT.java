...
public class ReaktorIT
{
    private final K3poRule k3po = new K3poRule()
        .addScriptRoot("net", "org/reaktivity/reaktor/network")
        .addScriptRoot("app", "org/reaktivity/reaktor/application");
    ...
    private final ReaktorRule reaktor = new ReaktorRule()
        ...
        .configurationRoot("org/reaktivity/reaktor/config")
        .external("app#0")
        .clean();
